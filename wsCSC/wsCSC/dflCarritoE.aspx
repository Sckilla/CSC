<%@ Page Title="" Language="C#" MasterPageFile="~/mpEmpleado.master" AutoEventWireup="true" CodeFile="dflCarritoE.aspx.cs" Inherits="dflCarritoE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <div style="margin:0 auto; width:170px">
            <a class="boton"; style="font-family:'Tw Cen MT'; color:#ffffff" href="dflCatalogoGralE.aspx">Ver más productos</a>
        </div>
        <br />
    </div>
    </div>
