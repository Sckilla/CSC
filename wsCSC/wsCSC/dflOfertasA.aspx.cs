...
public partial class dflOfertasA : System.Web.UI.Page
{
    ...
    protected void imgbIzq_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Write("<script language='javascript'>document.location.href='dflOfertasA.aspx?cve=" + Session["prodId"].ToString() + "&pag=" + npag + "'</script>");
    }
