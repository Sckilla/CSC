...
public partial class dflDetalleVentaA : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script language='javascript'>alert ('Selecciona un nuevo método de envío');document.location.href='dflSelecEnvA.aspx'</script>");
    }
    ...
    protected void InfoVenta()
    {
        ...
        if (msg != "")
        {
            Response.Write("<script language='javascript'>alert('Error al obtener:" + msg + " ');document.location.href='dflCarritoA.aspx'</script>");
        }
    }
    ...
    protected void imgbConfirmarC_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (msg != "")
        {
            Response.Write("<script language='javascript'>alert('Los campos:" + msg + "\\nSon obligatorios');document.location.href='dflCarritoA.aspx'</script>");
        }
        else
        {
            ...
            Response.Write("<script language='javascript'>alert('La venta con clave" + Session["CveVenta"].ToString() + " ha sido completada correctamente');document.location.href='dflDescripVentaA.aspx'</script>");
        }
    }
