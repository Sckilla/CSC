...
public partial class dflRepVentasTotE : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Response.Write("<script language='javascript'>alert('No se ha realizado ninguna compra con este usuario');document.location.href='dflMenuVentasE.aspx'</script>");
            }
            else
            {
