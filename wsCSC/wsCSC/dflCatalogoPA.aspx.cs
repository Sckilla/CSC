...
public partial class dflCatalogoPA : System.Web.UI.Page
{
    ...
    protected void dlCatálogo_ItemCommand(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName == "VerDetalle")
        {
            ...
            Response.Write("<script language='javascript'>document.location.href='dflDescProdA.aspx'</script>");
        }
    }
    ...
    protected void imgbIzq_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Write("<script language='javascript'>document.location.href='dflCatalogoPA.aspx?cve=" + Session["prodId"].ToString() + "&pag=" + npag + "'</script>");
    }
