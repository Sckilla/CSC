...
public partial class dflCarritoA : System.Web.UI.Page
{
    ...
    protected void datosCarrito()
    {
        ...
        if (cantp == 0)
        {
            Response.Write("<script language='javascript'>alert('No se ha añadido ningún producto al carrito');document.location.href='dflInicioA.aspx'</script>");
        }
    ...
    {
        Response.Write("<script language='javascript'>document.location.href='dflSelecEnvA.aspx'</script>");
    }
    ...
    protected void imgbPagar_Click(object sender, ImageClickEventArgs e)
    {
        if (Session["MetE"].ToString() != "0")
        {
            ...
            Response.Write("<script language='javascript'>document.location.href='dflSelecPagoA.aspx'</script>");
        }
        else
        {
            Response.Write("<script language='javascript'>alert('No se ha seleccionado un método de envío');document.location.href='dflSelecEnvA.aspx'</script>");
        }
    }
    ...
    protected void gvCarrito_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        Response.Write("<script language='javascript'>alert('Agregue su nueva cantidad deseada');document.location.href='dflDescProdA.aspx'</script>");
    }
}