...
public partial class dflComprasE : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script language='javascript'>alert('No se ha realizado ninguna compra o no existe ninguna compra activa para este usuario');document.location.href='dflMenuVentasE.aspx'</script>");
        }
        if (!IsPostBack)
        {
            LlenarGrid();
