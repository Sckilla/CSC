...
public partial class dflOfertasE : System.Web.UI.Page
{
    ...
    protected void imgbIzq_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Write("<script language='javascript'>document.location.href='dflOfertasE.aspx?cve=" + Session["prodId"].ToString() + "&pag=" + npag + "'</script>");
    }
