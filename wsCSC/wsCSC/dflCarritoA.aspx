<%@ Page Title="" Language="C#" MasterPageFile="~/mpAdministrador.master" AutoEventWireup="true" CodeFile="dflCarritoA.aspx.cs" Inherits="dflCarritoA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background:#ffffff">
        ...
        <img src="Imagenes/herramienta-dibujado-carrito-de-compras-mano_318-51871.jpg" style="height: 30px; width: 30px"/>&nbsp;&nbsp;
        CARRITO DE COMPRAS
        </div>
    ...
    <table style="border:0; width:90%; text-align: center; margin: 0 auto">
        <tr>
            ...
            <td>
                <table class="IndiCampos" style="border:0; width:100%; text-align: center; color:#000">
                    <tr class="Info">
    ...
    <div>
        ...
        <div style="margin:0 auto; width:170px">
            <a class="boton"; style="font-family:'Tw Cen MT'; color:#ffffff" href="dflCatalogoGralA.aspx">Ver más productos</a>
        </div>
        <br />
    </div>
    </div>
