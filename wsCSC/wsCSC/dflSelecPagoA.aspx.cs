...
public partial class dflSelecPagoA : System.Web.UI.Page
{
    ...
    protected void imgbContinuar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (lblMet.Text == "Tarjeta")
            {
                ...
                if (res == "0")
                {
                    Response.Write("<script language='javascript'>alert ('Se ha registrado su nuevo método de pago');document.location.href='dflDetalleVentaA.aspx'</script>");
                }
                else if (res == "2")
                {
                    Response.Write("<script language='javascript'>alert ('Las modificaciones se han realizado correctamnete');document.location.href='dflDetalleVentaA.aspx'</script>");
                }
                else
                {
                    Response.Write("<script language='javascript'>document.location.href='dflDetalleVentaA.aspx'</script>");
                }
            }
            if (lblMet.Text == "Transferencia")
            {
                ...
                if (res != "0")
                {
                    ...
                    Response.Write("<script language='javascript'>alert('Se ha recibido su método de pago para su verificación');document.location.href='dflDetalleVentaA.aspx'</script>");
                }
                else
                {
        ...
        {
            Response.Write("<script language='javascript'>alert('No se pudo realizar la acción');document.location.href='dflCarritoA.aspx'</script>");
        }
    }
