<%@ Page Title="" Language="C#" MasterPageFile="~/mpAdministrador.master" AutoEventWireup="true" CodeFile="dflABCOfertas.aspx.cs" Inherits="dflABCOfertas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-color:#000">
        ...
        <table class="IndiCampos" style="color:#ffffff; border:0; width:700px; text-align: center; margin:0 auto;">            
            <tr>
                ...
                <td >
                    ...
                    <asp:TextBox ID="txtRazon" runat="server" Width="50px" CssClass="txt" MaxLength="2"></asp:TextBox>

                &nbsp;
                    <asp:Label ID="lblporc" runat="server" CssClass="PrecioG" Text="%"></asp:Label>

                </td>
                <td style="color:#920101">
                    *</td>
                <td >
                    <asp:RegularExpressionValidator ID="revPrecio" runat="server" ErrorMessage="##" ForeColor="#CC0000" ControlToValidate="txtRazon" ValidationExpression="[0-9][0-9]*"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td >
                    ...
                    <asp:TextBox ID="txtNombreOfer" runat="server" Width="400px" CssClass="txt"></asp:TextBox>

                </td>
                <td style="color:#920101">
                    *</td>
                <td >
                    <asp:RegularExpressionValidator ID="revNombre" runat="server" ErrorMessage="Aaaa Aaaa" ForeColor="#CC0000" ControlToValidate="txtNombreOfer" ValidationExpression="([A-Z][a-z]+)(\s[A-Z][a-z]+)*"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td >
                    ...
                    <asp:ImageButton ID="imgCargar" runat="server" Height="70px" OnClick="imgCargar_Click" Width="350px" style="margin-left: 9px" BorderStyle="Solid" ImageUrl="~/Imagenes/promo.png" />
        ...
        <div class="Herramienta" style="width:410px; margin: 0 auto; text-align: center">
        ...
        <asp:GridView ID="gvProductos" runat="server" AllowPaging="True" CellPadding="4" GridLines="Horizontal" PageSize="1" HorizontalAlign="Center" AutoGenerateColumns="False" ForeColor="Black" OnSelectedIndexChanging="gvProductos_SelectedIndexChanging" OnPageIndexChanging="gvProductos_PageIndexChanging" OnRowDeleting="gvProductos_RowDeleting" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="Tablas">
            <Columns>
                ...
                <asp:BoundField DataField="NOMBRE" HeaderText="Oferta" />
                <asp:BoundField DataField="RAZON" HeaderText="Razón" DataFormatString="{0:P}" />
