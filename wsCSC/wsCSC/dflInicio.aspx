<%@ Page Title="" Language="C#" MasterPageFile="~/mpGeneral.master" AutoEventWireup="true" CodeFile="dflInicio.aspx.cs" Inherits="dflInicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin: 0 auto; text-align: center; background-color:#ffffff">
        ...
        <asp:SqlDataSource ID="sdsProductos" runat="server" ConnectionString="<%$ ConnectionStrings:cnnCSC_2019 %>" SelectCommand="TSP_ListarProdAleat" SelectCommandType="StoredProcedure" ProviderName="<%$ ConnectionStrings:cnnCSC_2019.ProviderName %>">
            <SelectParameters>
