...
public partial class dflReporteProdMenV : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                rptRep.Load(Server.MapPath("~/Reportes/crReporteProdMenV.rpt"));//se declara la ruta de ubicación del reporte
