...
public partial class dflOfertasG : System.Web.UI.Page
{
    ...
    protected void imgbIzq_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Write("<script language='javascript'>document.location.href='dflOfertasG.aspx?cve=" + Session["prodId"].ToString() + "&pag=" + npag + "'</script>");
    }
