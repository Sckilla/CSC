...
public partial class dflReporteTotalVentas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                rptRep.Load(Server.MapPath("~/Reportes/crReporteTotVentas.rpt"));//se declara la ruta de ubicación del reporte
